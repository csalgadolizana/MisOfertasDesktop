...
namespace Desk.Service_Cliente {
    ...
    public partial class Modificar_clienteRequest {
        ...
        public Modificar_clienteRequest(int id, System.DateTime fecha_nacimiento, string correo, string password, int telefono, string acepta_informativo, System.DateTime fecha_inicio, System.DateTime fecha_actualizacion, int id_ciudad, string id_estado, int id_persona) {
            this.id = id;
    ...
    public partial class Crear_clienteRequest {
        ...
        public Crear_clienteRequest(int id, System.DateTime fecha_nacimiento, string correo, string password, int telefono, string acepta_informativo, System.DateTime fecha_inicio, System.DateTime fecha_actualizacion, int id_ciudad, string id_estado, int id_persona) {
            this.id = id;
            this.fecha_nacimiento = fecha_nacimiento;
            this.correo = correo;
            this.password = password;
    ...
    public partial class ClienteServiceClient : System.ServiceModel.ClientBase<Desk.Service_Cliente.ClienteService>, Desk.Service_Cliente.ClienteService {
        ...
        public string Modificar_cliente(int id, System.DateTime fecha_nacimiento, string correo, string password, int telefono, string acepta_informativo, System.DateTime fecha_inicio, System.DateTime fecha_actualizacion, int id_ciudad, string id_estado, int id_persona) {
        ...
        public string Crear_cliente(int id, System.DateTime fecha_nacimiento, string correo, string password, int telefono, string acepta_informativo, System.DateTime fecha_inicio, System.DateTime fecha_actualizacion, int id_ciudad, string id_estado, int id_persona) {
