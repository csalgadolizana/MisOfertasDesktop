...
namespace Desk.Service_Usuario {
    ...
    public partial class AutenticacionResponse {
        ...
        public AutenticacionResponse(Desk.Service_Usuario.usuario @return) {
            this.@return = @return;
        }
    }
    ...
    public partial class UsuarioServiceClient : System.ServiceModel.ClientBase<Desk.Service_Usuario.UsuarioService>, Desk.Service_Usuario.UsuarioService {
        ...
        public System.Threading.Tasks.Task<Desk.Service_Usuario.Modificar_USUARIOResponse> Modificar_USUARIOAsync(int id, string correo, string password, int telefono, System.DateTime fecha_inicio, System.DateTime fecha_actualizacion, int id_estado, int id_persona, int id_cargo) {
            Desk.Service_Usuario.Modificar_USUARIORequest inValue = new Desk.Service_Usuario.Modificar_USUARIORequest();
            inValue.id = id;
            inValue.correo = correo;
            inValue.password = password;
        ...
        public Desk.Service_Usuario.usuario Autenticacion(string correo, string contrasena) {
